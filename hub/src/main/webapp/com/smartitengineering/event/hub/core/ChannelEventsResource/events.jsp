...
<html>
  ...
  <body>
    ...
    <a href="/api/all-channels"><< Back</a> <div id="pagi">
      <c:if test="${not empty first}">
        <a id="pagination" href="/api/channels/${channelId}/events/after/${first}${qParam}"><< Previous</a>
        <c:if test="${last!=1}">
          &nbsp;&nbsp;&nbsp;&nbsp;<a href="/api/channels/${channelId}/events/before/${last}${qParam}" id="pagination">Next >></a>
        </c:if>
      </c:if>
    </div>
  </body>
