<%-- 
    Document   : channelEventsFrags
    Created on : Aug 25, 2010, 4:43:40 PM
    Author     : kaisar
--%>
...
<br>
<div id="pagi">
  <a href="/api/channels/${channelId}/events/after/${first}/frags${qParam}" id="pagination"><< Previous</a>
  <a href="/api/channels/${channelId}/events/before/${last}/frags${qParam}" id="pagination">Next >></a>
</div>
